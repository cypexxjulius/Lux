...
public:
    inline void select(Box* new_box, v2 position)
    {
        if(m_box)
        {
            m_box->interaction = InteractionType::None;
            m_box->on_unselect();
        }

        m_box = new_box;
        m_box->interaction = InteractionType::Holding;
        m_box->on_select(position);
    }
    ...
    {
        m_box->on_unhold();
        m_box->interaction = InteractionType::Selected;
    }
    ...
    inline bool is_holding()
    {
        ...
        return m_box->interaction == InteractionType::Holding;
    } 
    ...
    inline bool is_selected()
    {
        ...
        return m_box->interaction == InteractionType::Selected;
    }
